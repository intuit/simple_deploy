...
describe SimpleDeploy::StackUpdater do
  ...
  it "should update the stack when parameters change and stack is stable" do
    ...
    stack_updater.update_stack_if_changes( [ { 'param1' => 'new-value' } ] ).
                  should == true
  end

  it "should update the stack when the template body changes and stack is stable" do
    attributes = { "param1" => "value1", "param3" => "value3" }
    entry_mock = mock 'entry mock'
    status_mock = mock 'status mock'
    cloud_formation_mock = mock 'cloud formation mock'
    ...
    stack_updater.update_stack_if_changes([], @new_template_body).should == true
  end
  ...
  it "should raise an error when parameters change and stack is not stable" do
    ...
    lambda {stack_updater.update_stack_if_changes( [ { 'param1' => 'new-value' } ] ) }.
                  should raise_error
  end

  it "should not update the stack when parameters and template_body don't change" do
    ...
    stack_updater.update_stack_if_changes( [ { 'another-param' => 'new-value' } ] ).
                  should == false
  end
